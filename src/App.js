    ...
    for (let i = 0; i < resultSearch.length; i++) {
      ...
      arrayItems.push(
            <div key={i} className="font-bold text-sm mb-2 capitalize tablerowbox">
                ...
                <Row sno={i} title={book.title} author={book.author} edition={book.edition} availability="10" link={book.poster} />
  ...
  return (
    ...
    <div id='section1' className="section1">
      ...
      <div className='searchtable'>
        ...
        <div className="flex flex-wrap searchResults rowresult">{resultCards}</div>
       </div>
       </div>
